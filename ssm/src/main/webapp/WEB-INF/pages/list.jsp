...
<div class="container">
    ...
    <nav aria-label="Page navigation">
        <ul class="pagination">
            <li>
                <a href="${pageContext.request.contextPath}/user/findAll?pageNum=${pages.pageNum-1}&user.address=${pages.user.address}&user.username=${pages.user.username}&user.email=${pages.user.email}" aria-label="Previous">
                    <span aria-hidden="true">&laquo;</span>
                </a>
            </li>
            <li><a href="">1</a></li>
            <li>
                <a href="${pageContext.request.contextPath}/user/findAll?pageNum=${pages.pageNum+1}&user.address=${pages.user.address}&user.username=${pages.user.username}&user.email=${pages.user.email}" aria-label="Next">
